...
import { DOING_POOJA_LABEL, NIMIT_SEVAK_LABEL, ambrishLabel, readMemberField } from './memberFlags';
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'is_nimit_sevak', label: NIMIT_SEVAK_LABEL, type: 'checkbox', lockedForSelf: true },
...
function requiredNames(tab, editing) {
