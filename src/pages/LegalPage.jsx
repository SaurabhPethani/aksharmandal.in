  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {type === 'delete' ? (
          <Pressable
            onPress={() => Linking.openURL(`mailto:${EMAIL}?subject=Delete%20my%20Akshar%20Connect%20account`)}
